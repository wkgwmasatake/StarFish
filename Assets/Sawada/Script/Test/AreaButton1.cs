...
public class AreaButton1 : MonoBehaviour {
    ...
    public void ButtonArea()//クリックした時
    {
        ...
        GameObject.Find("Area_Panel").transform.GetChild(1).gameObject.SetActive(true);
    ...
    IEnumerator FadeIn()
    {
        ...
        SceneManager.LoadScene("Stage_Fade_A");//ステージの読み込み
    }
}
